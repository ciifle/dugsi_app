...
class _SchoolAdminScreenState extends State<SchoolAdminScreen> {
  ...
  /// Stable mobile destinations: 0=Dashboard, 1=Classes, 2=Profile.
    ...
    return SafeArea(
      ...
      child: Column(
        children: [
          ...
          Expanded(child: _buildBodyForIndex(context)),
        ],
      ),
    );
  }
    ...
    return Scaffold(
      ...
      drawer: _bottomNavIndex == 0
          ? AppDrawer(
              onProfileTap: () {
                if (_nestedNavKey.currentState?.canPop() == true) {
                  _nestedNavKey.currentState?.popUntil(
                    (route) => route.isFirst,
                  );
                }
      ...
      body: Navigator(
        ...
        onGenerateRoute: (settings) {
          if (settings.name == '/') {
            return MaterialPageRoute(builder: (_) => _buildTabView());
          }
          return null;
        },
      ),
  ...
  Widget _buildDesktopLayout(bool feesEnabled) {
    return WebAdminShell(navigatorKey: _nestedNavKey, onSearch: _onSearch);
  }

  Widget _buildDesktopBody(bool feesEnabled) {
    switch (_bottomNavIndex) {
      case 1:
        return const AdminClassesPage(embedBodyOnly: false);
      case 2:
  ...
  Widget _buildBodyForIndex(BuildContext context) {
    ...
    switch (_bottomNavIndex) {
      case 1:
        return const AdminClassesPage(embedBodyOnly: true);
      case 2:
      ...
      child: GridView.count(
        ...
        children: [
          ...
          _NeumorphicStatCard(
            ...
            growth: "+0%",
            onTap: () => _nestedNavKey.currentState
                ?.push(
                  MaterialPageRoute(
            ...
            children: [
              ...
              _QuickActionButton(
                ...
                onTap: () => _nestedNavKey.currentState
                    ?.push(
                      MaterialPageRoute(
                        builder: (_) =>
                            const AdminFeesScreen(openCreateOnLoad: true),
                      ),
                    )
                    .then((_) => _loadData()),
              ),
              ...
              _QuickActionButton(
                ...
                onTap: () => _nestedNavKey.currentState
                    ?.push(
                      MaterialPageRoute(
                        builder: (_) =>
                            const AdminAttendanceScreen(defaultToToday: true),
                      ),
                    )
                    .then((_) => _loadData()),
              ),
              _QuickActionButton(
                ...
                onTap: () => _nestedNavKey.currentState
                    ?.push(
                      MaterialPageRoute(
                        builder: (_) =>
                            const AdminSubjectsScreen(openCreateOnLoad: true),
                      ),
                    )
                    .then((_) => _loadData()),
              ),
              _QuickActionButton(
                ...
                onTap: () => _nestedNavKey.currentState
                    ?.push(
                      MaterialPageRoute(
                        builder: (_) => const AdminClassSubjectsScreen(),
                      ),
                    )
                    .then((_) => _loadData()),
              ),
              ...
              _QuickActionButton(
                ...
                onTap: () => _nestedNavKey.currentState
                    ?.push(
                      MaterialPageRoute(
                        builder: (_) =>
                            const AdminTimetableScreen(openAddSlotOnLoad: true),
                      ),
                    )
                    .then((_) => _loadData()),
              ),
              ...
              _QuickActionButton(
                ...
                onTap: () => _nestedNavKey.currentState
                    ?.push(
                      MaterialPageRoute(
                        builder: (_) => const AdminExamsScreen(),
                      ),
                    )
                    .then((_) => _loadData()),
              ),
              _QuickActionButton(
                ...
                onTap: () => _nestedNavKey.currentState
                    ?.push(
                      MaterialPageRoute(
                        builder: (_) =>
                            const AdminExamsScreen(openCreateOnLoad: true),
                      ),
                    )
                    .then((_) => _loadData()),
              ),
              ...
              _QuickActionButton(
                ...
                onTap: () => _nestedNavKey.currentState
                    ?.push(
                      MaterialPageRoute(
                        builder: (_) =>
                            const AdminMarksScreen(openCreateOnLoad: true),
                      ),
                    )
                    .then((_) => _loadData()),
              ),
              ...
              _QuickActionButton(
                ...
                onTap: () => _nestedNavKey.currentState
                    ?.push(
                      MaterialPageRoute(
                        builder: (_) =>
                            const AdminNoticesScreen(openCreateOnLoad: true),
                      ),
                    )
                    .then((_) => _loadData()),
              ),
...
/// Same floating container as dashboard header, but title only for secondary tabs.
...
class _BottomNav extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    const labels = ["Dashboard", "Classes", "Profile"];
    const count = 3;
