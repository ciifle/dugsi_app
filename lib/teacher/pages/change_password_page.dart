...
/// [AcademicPerformanceService.changeTeacherPassword] — mirrors the
/// admin/student change-password pages (same field design, validation,
/// duplicate-submit guard, and embed-safe pop behavior).
class TeacherChangePasswordPage extends StatefulWidget {
  final bool embedBodyOnly;

  const TeacherChangePasswordPage({Key? key, this.embedBodyOnly = false})
    : super(key: key);
...
class _TeacherChangePasswordPageState extends State<TeacherChangePasswordPage> {
  ...
  Future<void> _submit() async {
    ...
    final result = await AcademicPerformanceService().changeTeacherPassword(
